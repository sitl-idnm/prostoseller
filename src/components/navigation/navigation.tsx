                ...
                <div className={styles.wrapper}>
                  <div className={styles.menu} onClick={(e) => e.stopPropagation()}>
                    ...
                    <div className={styles.menuCta}>
                      <Button isRouteLink as='a' href='https://lk.prostoseller.com/index.php?r=site%2Fsignup' variant='gradient' buttonWidth="90%" onClick={() => setIsOpen(false)}>Зарегистрироваться</Button>
                      <Button isRouteLink as='a' href="https://lk.prostoseller.com/index.php?r=site%2Flogin" variant='gradientOutline' buttonWidth="70%" onClick={() => setIsOpen(false)}>Войти</Button>
                    </div>
