  ...
  return (
    <main className={rootClassName}>
      <Wrapper className={styles.wrapper}>
        ...
        <Content
          variant="split"
          backgroundRoot={'linear-gradient(90deg, rgba(250, 69, 126, 1) 0%, rgba(0, 91, 255, 1) 100%)'}
          backgroundContent="transparent"
